  ...
  for (let n = 0; n < input.length; n++) {
    ...
    if (n < input.length - 1) {
      ...
      if (Object.prototype.hasOwnProperty.call(letterKey, midHeart)) {
        convertedLetters.push(letterKey[midHeart]);
        n++;
        continue;
      }
    }
    ...
    if (n < input.length - 2) {
      ...
      if (Object.prototype.hasOwnProperty.call(specialCases, midILY)) {
        convertedLetters.push(specialCases[midILY]);
        n += 2;
        continue;
      }
    }
    ...
    if (n < input.length - 7) {
      ...
      if (Object.prototype.hasOwnProperty.call(specialCases, midILoveU)) {
        convertedLetters.push(specialCases[midILoveU]);
        n += 7;
        continue;
      }
    }
